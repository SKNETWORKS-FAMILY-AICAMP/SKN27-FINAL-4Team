...
소비자: graph_memory_v2_base(운영 유일 스키마 — v1은 2026-07-21 완전 철거).
"""
import os
...
# panel_summary  : 기억 패널(프론트 칩·팝오버) 노출 상한 — 다가오는 일 4 /
#                  취향 3 / 인물 3 / 최근 3 (2026-07-20 신설, 장부 등재 2026-07-21)
# 토큰 최소 길이 2 : _tokens()·만료 대상 파싱의 한 글자 조사 배제 (결정적 게이트 상수)
